      ...
      <div className="max-w-2xl w-full bg-white p-10 rounded-3xl shadow-xl border border-slate-100">
        <header className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-2">
            Dados pessoais e sua última formação acadêmica.
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-teal-500 outline-none"
                />
              </div>
              <div className="relative">
                <Phone
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                type="text"
                required
                placeholder="Instituição (Ex: USP, Alura, Arrastão)"
                className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-teal-500 outline-none"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="Grau (Ex: Bacharelado, Técnico)"
                  className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-teal-500 outline-none"
                />
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="Curso (Ex: Análise de Sistemas)"
                  className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-teal-500 outline-none"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-black text-slate-400 uppercase mb-1 ml-2">
                  Início
                </label>
                <div className="relative">
                  <Calendar
          ...
          <button
            ...
            className="w-full bg-slate-900 text-white py-5 rounded-2xl font-black flex items-center justify-center gap-3 hover:bg-teal-600 transition-all shadow-lg active:scale-95 disabled:bg-slate-300 uppercase tracking-widest"
          >
            {isSubmitting ? (
              <>
