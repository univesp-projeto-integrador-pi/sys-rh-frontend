...
const api = axios.create({
  baseURL: 'http://localhost:3000/api/v1', // Adicionado /v1
...
export const createCandidate = (data: any) => api.post('/candidates-external', data);
export const updateCandidate = (id: string, data: any) => api.put(`/candidates-external/${id}`, data);
